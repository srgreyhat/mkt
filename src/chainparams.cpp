...
public:
    CMainParams()
    {
        ...
        strBurnAddress = "mY3drMkK5WV98bCDCw7oiPqi5Qbj44hMVz";
        strBurnAddress = "mQeJY8BwEhM4bvWLZCzd8NSchtreLwSotB";
        strBurnAddress = "mJF6SpGC38Y7QKXc4fUL3s3wbv5KxH5Wns";
        strBurnAddress = "mWawy8HhCnXypQeBiXefwRCThfHeG6R3bX";
        strBurnAddress = "ma8NHgLzxDcLGi56fNrVKKMxvkapDszni1";
        strBurnAddress = "mP3S3ryiuifRKoRJSpNKHNddkrGDEztQPH";
        strBurnAddress = "mX1BChGhMdZ3n9r2XenGF9LHzz5adozabU";
